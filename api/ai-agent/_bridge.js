...
export async function sendViaBridge(bridgeUrl, bridgeToken, phone, message, customerName) {
  ...
  try {
    const r = await fetch(url, {
      method: "POST",
      headers,
      body: JSON.stringify({ messages: [{ phone, message, customerName: customerName || "" }] }),
      signal: ctrl.signal,
    });
