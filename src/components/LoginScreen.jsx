...
export const TABS=[
  ...
  {key:"purchasePipelineOrders",label:"أوامر الشراء",icon:"📑",color:"#8B5CF6",bg:"#EDE9FE",svg:<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 15l2 2 4-4"/></>},
  ...
  {key:"accountStatement",label:"كشف حساب",icon:"📊",color:"#0EA5E9",bg:"#E0F2FE",svg:<><path d="M3 3v18h18"/><path d="M7 14l4-4 4 4 5-5"/></>},
