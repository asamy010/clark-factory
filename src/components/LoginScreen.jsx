...
export const TABS=[
  ...
  /* V21.9.115: Unified Contacts directory (customers + suppliers + workshops + employees).
     Sits right after dashboard so it's discoverable as the canonical "who do we talk to" entry. */
  {key:"contacts",label:"جهات الاتصال",icon:"👥",color:"#DB2777",bg:"#FCE7F3",svg:<><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></>},
  {key:"details",label:"التصنيع",icon:"✂️",color:"#8B5CF6",bg:"#EDE9FE",svg:<><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><line x1="20" y1="4" x2="8.12" y2="15.88"/><line x1="14.47" y1="14.48" x2="20" y2="20"/><line x1="8.12" y1="8.12" x2="12" y2="12"/></>},
  /* V21.23.1: AI Studio — تلبيس الموديلات (virtual try-on) بـ Nano Banana Pro.
     زر أساسي في الهوم (أمر Ahmed) — برّه التصنيع. أيقونة sparkles. */
  {key:"aiStudio",label:"AI Studio",icon:"🪄",color:"#A855F7",bg:"#F3E8FF",svg:<><path d="M12 3l1.9 5.8a2 2 0 0 0 1.3 1.3L21 12l-5.8 1.9a2 2 0 0 0-1.3 1.3L12 21l-1.9-5.8a2 2 0 0 0-1.3-1.3L3 12l5.8-1.9a2 2 0 0 0 1.3-1.3z"/><path d="M19 3v4"/><path d="M21 5h-4"/></>},
  ...
  /* V21.9.95 — Documents Tree (folder-based document manager).
     Icon: folder with file inside (representing a tree of folders + files). */
  {key:"documents",label:"مساحة التخزين",icon:"💾",color:"#8B5CF6",bg:"#EDE9FE",svg:<><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></>},
];
