...
const CHANGELOG = [
  {
    ...
    date: "2026-05-02",
    types: ["fix"],
    title: "🔔 رسالة واضحة عند رفض حفظ حركة الخزنة (سبب 'الحقول مش بتتفرغ')",
    changes: [
      { type: "fix", text: "🐛 المشكلة المُبلَّغ عنها: 'بعد ضغط حفظ، الحقول مش بتتفرغ.' السبب الحقيقي: المستخدم كان بيضغط حفظ والمبلغ صفر (أو فارغ)، الـvalidation كانت بترفض الحفظ بصوت بيب فقط بدون أي رسالة مرئية. النتيجة: المستخدم يفتكر إن الحفظ نجح والمشكلة في التفريغ، لكن في الحقيقة الحفظ مكنش بيتنفذ أصلاً." },
      { type: "fix", text: "🚨 الدليل من الـscreenshot: 'وضع التكرار: متبقي 30' (لو كان حصل save فعلاً، الرقم كان نزل لـ29). والمبلغ شكله 0.00 — دي بالظبط الحالة اللي بتسبب الرفض الصامت." },
      { type: "fix", text: "✅ الإصلاح: في saveTx، رفض المبلغ صفر دلوقتي بيظهر toast واضح: '⛔ المبلغ مطلوب — اكتب قيمة أكبر من صفر'. واليوم المقفول كمان رسالته اتأكدت إنها موجودة. كده المستخدم هيشوف فوراً ليه الحفظ مش بيحصل بدل ما يفتكر إن في bug." },
      { type: "fix", text: "📝 ملاحظة: لو لسه شايف مشكلة 'الحقول مش بتتفرغ' بعد دلوقتي، فالمشكلة فعلاً في التفريغ. اعمل refresh كامل للصفحة (Ctrl+Shift+R أو حذف cache المتصفح) عشان تتأكد إن آخر version متحملة." },
    ]
  },
  {
    version: "V19.6",
