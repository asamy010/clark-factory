...
const CHANGELOG = [
  {
    ...
    title: "💰 توضيح حسابات الورش: كل تسليم بسعره (بدون متوسطات)",
    changes: [
      { type: "fix", text: "🐛 المشكلة: في تقرير 'حساب الورشة' الجدول كان بيعرض 'متوسط السعر' محسوب من التسليمات (مثلاً 17.93)، بينما 'القيمة' محسوبة من الاستلامات بأسعارها الفردية (مثلاً 140,700.5). ده كان بيخلي المستخدم يحسب 6,193 × 17.93 ويلاقي 111,040 — مش متطابق مع 140,700 المعروض. لأن السعرين من مصدرين مختلفين." },
      ...
      { type: "improvement", text: "📅 Timeline الحركات: أضفت عمود 'القيمة' لكل سطر = الكمية × السعر. الاستلامات بتعرض القيمة بلون أخضر، التسليمات تعرض '—' (لأنها مش مستحق فعلي بعد). صف إجمالي جديد في الآخر: 'إجمالي الاستلامات (المستحق)' بيجمع الكمية + القيمة للاستلامات فقط — ده الرقم المتطابق مع كشف الحساب." },
      { type: "improvement", text: "📤 Excel + Print: نفس التغييرات مطبقة على التصدير وطباعة التقرير — جدول القطع بدون 'متوسط السعر'، Timeline فيه عمود 'القيمة' وصف 'إجمالي الاستلامات (المستحق)'." },
      { type: "improvement", text: "📱 بورتال الورشة (WorkshopPortalPage): أضفت ملاحظة توضيحية في تاب 'الملخص': 'كل عملية استلام لها سعرها الفردي · إجمالي حساب التشغيل = مجموع (الكمية × سعرها) لكل استلام'. الـbreakdown في تاب 'الحركات' بيعرض كل receive بمعادلتها (10 × 357 = 3,570) + المجموع." },
      { type: "improvement", text: "🔍 Subtitle جديد فوق جدول القطع (في الشاشة + الطباعة): 'كل استلام له سعره الفردي · القيمة المستحقة = مجموع (الكمية × سعرها) لكل عملية استلام' — توضيح للمستخدم إن المنطق مبني على الأسعار الفردية." },
