...
const CHANGELOG = [
  {
    ...
    title: "🤖 إصلاح اتجاه الأرصدة في البوت + تعديلات الصفحة الرئيسية",
    changes: [
      { type: "fix", text: "🚨 Bug في المساعد الذكي: كان بيكتب 'الورشة عليها كذا' بدل 'الورشة ليها كذا' — في الحالات اللي المصنع مدين فيها للورشة (الـbalance موجب). السبب: الـfield كان اسمه `owedMoney` غامض الاتجاه، والنموذج كان بيخلط بين الدائن والمدين. الإصلاح: (1) تغيير الاسم لـ`factoryOwesWorkshop` صريح المعنى. (2) تعليمات أقوى في الـprompt مع مثال مباشر بالأرقام. (3) قاعدة محددة: موجب = 'ليها' (الورشة دائنة)، سالب = 'عليها' (الورشة مدينة)، صفر = حساب متسوّي." },
      { type: "improvement", text: "🎨 الصفحة الرئيسية: gap الـgrid (الفراغات بين الأزرار) من 8 → 10 (+25%). gap الداخلي بين الأيقونة والنص من 8 → 4 (تقليل المساحة البيضاء حول النص). الأزرار محفوظة مربعة 6 أعمدة." },
    ]
  },
  {
    version: "V18.81",
