...
export const APP_VERSION = "V21.27.109";
...
/* V21.27.19: باليت موسّعة (~64 لون) منظّمة بالعائلات. الأسماء القديمة محفوظة. */
export const COLORS_DB = [
  {n:"ابيض",h:"#FFFFFF"},{n:"أوف وايت",h:"#F5F0E6"},{n:"كريمي",h:"#FFF8DC"},{n:"بيج",h:"#D4C5A9"},{n:"رملي",h:"#E0CDA9"},{n:"شامبانيا",h:"#F1E0C5"},
  {n:"رمادي فاتح",h:"#CBD5E1"},{n:"رمادي",h:"#8B8B8B"},{n:"رمادي غامق",h:"#4B5563"},{n:"فحمي",h:"#36454F"},{n:"اسود",h:"#1a1a1a"},
  {n:"احمر",h:"#C62828"},{n:"احمر فاتح",h:"#EF5350"},{n:"نبيتي",h:"#6A1B29"},{n:"عنابي",h:"#7B1F2B"},{n:"خمري",h:"#5E1A2A"},{n:"طوبي",h:"#B7410E"},{n:"مرجاني",h:"#FF6F61"},
  {n:"برتقالي",h:"#E65100"},{n:"مشمشي",h:"#FFAB91"},{n:"خوخي",h:"#FFB7A0"},{n:"سلمون",h:"#EF9A9A"},
  {n:"اصفر",h:"#F9A825"},{n:"ليموني",h:"#FFEB3B"},{n:"مستردة",h:"#C9A227"},{n:"ذهبي",h:"#D4AF37"},{n:"عسلي",h:"#C68E3F"},
  {n:"زيتي",h:"#556B2F"},{n:"زيتوني فاتح",h:"#8A9A5B"},{n:"اخضر",h:"#2E7D32"},{n:"اخضر فاتح",h:"#66BB6A"},{n:"اخضر غامق",h:"#1B5E20"},{n:"فستقي",h:"#93C572"},{n:"كاكي",h:"#8D6E63"},
  {n:"منت",h:"#80CBC4"},{n:"نعناعي",h:"#A8E6CF"},{n:"تيفاني",h:"#81D8D0"},{n:"تركواز",h:"#1ABC9C"},{n:"فيروزي",h:"#40E0D0"},{n:"بترولي",h:"#0E7C7B"},
  {n:"لبني",h:"#81D4FA"},{n:"سماوي",h:"#00ACC1"},{n:"ازرق فاتح",h:"#42A5F5"},{n:"ازرق",h:"#1565C0"},{n:"ازرق غامق",h:"#0D47A1"},{n:"كحلي",h:"#1B2A4A"},{n:"نيلي",h:"#3F51B5"},
  {n:"لافندر",h:"#B39DDB"},{n:"بنفسجي",h:"#6A1B9A"},{n:"موف",h:"#9C27B0"},{n:"ارجواني",h:"#8E24AA"},
  {n:"بمبي",h:"#F8BBD0"},{n:"وردي",h:"#F48FB1"},{n:"روز",h:"#E91E63"},{n:"زهري",h:"#EC407A"},{n:"فوشيا",h:"#D81B60"},
  {n:"لحمي",h:"#E8BEAC"},{n:"جملي",h:"#C19A6B"},{n:"بني فاتح",h:"#A1887F"},{n:"بني",h:"#5D4037"},{n:"موكا",h:"#6F4E37"},{n:"بني غامق",h:"#3E2723"},
  {n:"فضي",h:"#C0C0C0"},{n:"نحاسي",h:"#B87333"},
];

/* ── Theme System ── */
export const THEMES = {
  light:{name:"فاتح",bg:"#EFF6FF",card:"rgba(255,255,255,0.9)",cardSolid:"#FFF",glass:"rgba(255,255,255,0.6)",brd:"rgba(148,163,184,0.2)",brdStrong:"rgba(148,163,184,0.4)",text:"#1E293B",textSec:"#64748B",textMut:"#94A3B8",accent:"#2E7BED",accentBg:"#E8F1FF",ok:"#10B981",err:"#EF4444",warn:"#F59E0B",purple:"#8B5CF6",shadow:"0 2px 12px rgba(0,0,0,0.04)",sidebarBg:"#FFF",inputBg:"#FFF",bodyBg:"#EFF6FF"},
  pink:{name:"بينك",bg:"#FFF0F5",card:"rgba(255,255,255,0.95)",cardSolid:"#FFF5F8",glass:"rgba(255,240,245,0.7)",brd:"rgba(236,72,153,0.15)",brdStrong:"rgba(236,72,153,0.3)",text:"#4A1942",textSec:"#9D4E8C",textMut:"#C084A8",accent:"#DB2777",accentBg:"#FCE7F3",ok:"#059669",err:"#E11D48",warn:"#D97706",purple:"#A855F7",shadow:"0 2px 12px rgba(236,72,153,0.08)",sidebarBg:"#FFF5F8",inputBg:"#FFF",bodyBg:"#FFF0F5"},
  odoo:{name:"بيربل",bg:"#EFEDF0",card:"rgba(255,255,255,0.95)",cardSolid:"#FFFFFF",glass:"rgba(255,255,255,0.7)",brd:"rgba(113,75,103,0.12)",brdStrong:"rgba(113,75,103,0.25)",text:"#2C2C33",textSec:"#6B7280",textMut:"#9CA3AF",accent:"#714B67",accentBg:"#F3EDF2",ok:"#21B799",err:"#D94F70",warn:"#E4A93F",purple:"#714B67",shadow:"0 2px 10px rgba(113,75,103,0.06)",sidebarBg:"#FFFFFF",inputBg:"#FFFFFF",bodyBg:"#EFEDF0",navBg:"#714B67",navText:"#FFFFFF"}
};
...
/* V21.27.80: المطبوعات والتقارير بالأسود الغامق فقط (طلب Ahmed — المبيعات
   والمشتريات؛ طُبِّق عامًّا للتناسق وتوفير الحبر). كل الألوان أسود + خلفيات فاتحة
   للقراءة + override أخير «body *{color:#000!important}» يجبر أي لون inline في
   بُناة الطباعة (printPo/printReceipt/printInvoice...) على الأسود — بحيث الـ PDF
   والطباعة الفعلية أسود بالكامل. */
export const PRINT_CSS="*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Cairo',Arial,sans-serif;padding:24px 28px;font-size:12px;direction:rtl;color:#000;line-height:1.5}.hdr{display:flex;justify-content:space-between;align-items:center;border-bottom:3px solid #000;padding-bottom:12px;margin-bottom:20px}.hdr img{height:26px}.hdr-info{text-align:left;font-size:11px;color:#000;font-weight:700}h2{font-size:15px;color:#000;margin:14px 0 8px;padding-bottom:4px;border-bottom:2px solid #000}h3{font-size:13px;color:#000;margin:10px 0 6px}table{width:100%;border-collapse:collapse;margin:8px 0 14px;border:1px solid #000}th{background:#E5E7EB;font-weight:800;font-size:10px;color:#000;padding:5px 8px;text-align:right;border:1px solid #000;letter-spacing:0.3px}td{padding:4px 8px;text-align:right;border:1px solid #000;font-size:11px}tr:nth-child(even){background:#F3F4F6}.info{font-weight:700;color:#000}.ok{color:#000;font-weight:700}.err{color:#000;font-weight:700}.warn{color:#000;font-weight:700}.sig{margin-top:40px;display:flex;justify-content:space-around;gap:20px}.sig-box{text-align:center;min-width:150px;border-top:2px solid #000;padding-top:10px;font-weight:700;font-size:12px}.badge{display:inline-block;padding:2px 10px;border-radius:6px;font-size:10px;font-weight:700;margin:2px;border:1px solid #000}.foot{margin-top:30px;padding-top:10px;border-top:1px solid #000;text-align:center;font-size:9px;color:#000;font-weight:600}@media print{body{padding:12px}table{page-break-inside:auto}tr{page-break-inside:avoid}@page{margin:12mm;@bottom-center{content:counter(page)' / 'counter(pages)}}}#report-content *,body>*:not(.pbar) *,.hdr *,table *,.sig *,.foot *{color:#000 !important}";
