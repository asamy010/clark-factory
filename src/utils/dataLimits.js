...
import {
  SPLIT_FIELDS_V1674, SPLIT_FIELDS_V1949, SPLIT_FIELDS_V1950, SPLIT_FIELDS_V1952, SPLIT_FIELDS_V1953, SPLIT_FIELDS_V2195, SPLIT_FIELDS_V2197, SPLIT_FIELDS_V2198, SPLIT_FIELDS_V21100, SPLIT_FIELDS_V21101,
  SPLIT_FLAG_V1674, SPLIT_FLAG_V1949, SPLIT_FLAG_V1950, SPLIT_FLAG_V1952, SPLIT_FLAG_V1953, SPLIT_FLAG_V2195, SPLIT_FLAG_V2197, SPLIT_FLAG_V2198, SPLIT_FLAG_V21100, SPLIT_FLAG_V21101,
...
function _migratedFields(d){
  ...
  if (d[SPLIT_FLAG_V21100]) SPLIT_FIELDS_V21100.forEach(f => set.add(f));
  if (d[SPLIT_FLAG_V21101]) SPLIT_FIELDS_V21101.forEach(f => set.add(f));
  return set;
}
