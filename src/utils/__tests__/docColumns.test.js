...
describe("buildDocColumns — الأعمدة الأساسية", () => {
  it("بند بيع: الكود/الاسم/الوحدة + قبل وبعد الخصم لكل صف", () => {
    ...
    expect(totals).toEqual({ subBefore: 1000, discount: 100, discountPct: 10, subAfter: 900 });
  });
...
describe("buildDocColumns — توزيع الخصم الكلي (الضمانة الذهبية)", () => {
  it("خصم رأس % بيتوزّع على الصفوف ومجموع بعد الخصم = الإجمالي", () => {
    ...
    expect(totals).toEqual({ subBefore: 1500, discount: 150, discountPct: 10, subAfter: 1350 });
  ...
  it("خصم بنود + خصم رأس معاً: الصف بيجمع الاتنين", () => {
    ...
    expect(totals).toEqual({ subBefore: 1000, discount: 190, discountPct: 19, subAfter: 810 });
  });
  ...
  it("بدون خصم: قبل = بعد، وعمود الخصم صفر", () => {
    ...
    expect(totals).toEqual({ subBefore: 100, discount: 0, discountPct: 0, subAfter: 100 });
  });
