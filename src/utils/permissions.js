...
export const PERMISSION_TABS = [
  ...
  /* V21.10.5 — Purchase Pipeline #3 Slice 6: RFQs as upstream document. */
  { key: "purchaseRFQs",     label: "عروض الموردين",       icon: "📋", group: "purchase" },
  /* V21.10.6 — Purchase Pipeline #3 Slices 7-8: Pipeline POs */
  { key: "purchasePipelineOrders", label: "أوامر الشراء", icon: "📑", group: "purchase" },
...
export const DEFAULT_PERMS = {
  admin: {
    ...
    purchaseRFQs:"edit", purchasePipelineOrders:"edit", purchase:"edit", purchaseInvoices:"edit", debitNotes:"edit",
  ...
  sales_accountant: {
    ...
    salesQuotations:"edit", salesOrders:"edit", salesInvoices:"edit", creditNotes:"edit",
    purchaseRFQs:"hide", purchasePipelineOrders:"hide", purchase:"hide", purchaseInvoices:"hide", debitNotes:"hide",
  ...
  warehouse_keeper: {
    ...
    salesQuotations:"hide", salesOrders:"hide", salesInvoices:"hide", creditNotes:"hide",
    purchaseRFQs:"hide", purchasePipelineOrders:"hide", purchase:"edit", purchaseInvoices:"hide", debitNotes:"hide",
  ...
  viewer: {
    ...
    purchaseRFQs:"view", purchasePipelineOrders:"view", purchase:"view", purchaseInvoices:"view", debitNotes:"view",
    warehouse:"view", pieces:"view", treasury:"hide",
    hr: {weeks:"hide",verify:"hide",employees:"hide",security:"hide"},
