...
export const DEFAULT_PERMS = {
  admin: {
    ...
    campaigns:"edit", automation:"edit", audit:"edit",
  ...
  manager: {
    ...
    campaigns:"edit", automation:"view", audit:"view",
  ...
  sales_accountant: {
    ...
    campaigns:"edit", automation:"hide", audit:"hide",
  ...
  purchase_accountant: {
    ...
    warehouse:"edit", treasury:"edit",
    hr: {weeks:"hide",verify:"hide",employees:"hide",security:"hide"},
    campaigns:"hide", automation:"hide", audit:"hide",
    accounting:"hide", fixedAssets:"hide",
    settings:"hide",
  },
