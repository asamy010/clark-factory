  ...
  return<div>
    ...
    {subTab==="finished"&&<Card>
      <div style={{padding:20,textAlign:"center"}}>
        ...
        <div style={{fontSize:FS-1,color:T.textSec,marginBottom:14}}>لإدارة تسليم المخزن الجاهز (المستلم من الورش)، استخدم تبويبة "تسليم مخزن جاهز"</div>
