...
export function CustDeliverPg({data,upConfig,upSales,upTasks,updOrder,isMob,isTab,canEdit,user,season}){
  ...
  const printShippingLabel=async(cust,sessDate,items,total,shipN)=>{
    ...
    pw.document.write("<!DOCTYPE html><html dir='rtl'><head><meta charset='utf-8'/><link href='https://fonts.googleapis.com/css2?family=Markazi+Text:wght@400;500;600;700&family=Cairo:wght@600;800&display=swap' rel='stylesheet'/><style>"
    +"@page{size:10cm 15cm;margin:0}*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Markazi Text','Cairo',serif;color:#000}"
    ...
    +".pbar button{padding:5px 14px;border-radius:6px;border:1px solid #000;cursor:pointer;font-family:'Markazi Text','Cairo',serif;font-size:11px;font-weight:700;background:#fff}.pbar .pr{background:#000;color:#fff}"
  ...
  return<div className="sales-page-buttons">
    ...
    {(()=>{
      ...
      const printSalesReport=()=>{const w=openPrintWindow();if(!w){tell("المتصفح يمنع الطباعة","فعّل النوافذ المنبثقة وحاول مرة أخرى",{danger:true});return}
        ...
        <style>@page{size:A4;margin:10mm}*{box-sizing:border-box}body{font-family:'Markazi Text','Cairo',Arial,serif;font-size:11px;margin:0;padding:0;color:#1a1a1a}
    ...
    {groupPrint&&(()=>{const sess=sessions.find(s=>s.id===groupPrint.sessId);if(!sess)return null;
      ...
      const buildOneCustomerHTML = async (c, sigStr, opts) => {
        ...
        const styles =
          ...
          "body{font-family:'Markazi Text','Cairo',Arial,serif;padding:24px 28px;font-size:12px;direction:rtl;color:#1E293B;line-height:1.5}"+
          ...
          ".h{background:linear-gradient(180deg,#E2E8F0,#CBD5E1)!important;font-family:'Markazi Text','Cairo',serif;font-weight:700;font-size:10px;color:#1E293B;padding:5px 8px;text-align:right;border:1px solid #94A3B8;letter-spacing:0.3px}"+
          "tr:nth-child(even){background:#F8FAFC}"+
        ...
        h += "<div class='sig'><div class='sig-box'>مسؤول التسليم</div><div class='sig-box'>توقيع العميل<br/>"+c.name+"</div></div>";
        h += "<div class='foot'><span class='foot-brand'>"+factoryName+"</span><span class='foot-meta'>"+today+" • Powered by CLARK Factory Management</span></div>";
    ...
    {availPopup && (()=>{
      ...
      const buildReportHTML = () => {
        ...
        const styles =
          "*{margin:0;padding:0;box-sizing:border-box}"+
          "body{font-family:'Markazi Text','Cairo',Arial,serif;padding:20px 24px;font-size:12px;direction:rtl;color:#1E293B;line-height:1.5}"+
          ...
          ".h{background:linear-gradient(180deg,#FEF3C7,#FDE68A)!important;font-family:'Markazi Text','Cairo',serif;font-weight:700;font-size:10px;color:#78350F;padding:6px 8px;text-align:center;border:1px solid #D97706;letter-spacing:0.3px}"+
