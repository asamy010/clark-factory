...
import { gid, fmt, fmt0, r2, fmtDate, hrsToHM, parseHrs, dayName, openWA } from "../utils/format.js";
...
export function HRPg({data,upConfig,isMob,canEdit,user,userRole,getHrSubPerm,setSavingOverlay}){
  ...
  const SLIP_STYLES=`<style>
    ...
    *{box-sizing:border-box}
    ...
    body{font-family:'Markazi Text','Cairo',Arial,serif;font-size:13px;padding:0;margin:0;color:#1a1a1a}
  ...
  return<div>
              ...
              <div style={{flex:"0 0 auto",marginInlineStart:"auto",display:"flex",gap:6}}>
                ...
                <Btn small onClick={()=>{
                  ...
                  const html="<html dir='rtl'><head><meta charset='UTF-8'><title>"+title+"</title>"+
                    ...
                    "body{font-family:'Markazi Text','Cairo',Arial,serif;padding:18px 22px;font-size:11px;direction:rtl;color:#1E293B;line-height:1.5}"+
    ...
    {empStatement&&(()=>{const emp=employees.find(e=>e.id===empStatement);if(!emp)return null;
      ...
      const printStmt=()=>{const w=_openPrintWin();if(!w)return;
        ...
        <style>@page{size:A4;margin:10mm}body{font-family:'Markazi Text','Cairo',Arial,serif;font-size:11px;margin:0;padding:0;color:#1a1a1a}
      ...
      return<div>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14,flexWrap:"wrap",gap:8}}>
          ...
          <Btn small onClick={()=>{
            ...
            <style>@page{size:A4;margin:10mm}body{font-family:'Markazi Text','Cairo',Arial,serif;font-size:11px;margin:0;padding:0}
    ...
    {view==="verify"&&(()=>{
      ...
      const doWhatsapp=()=>{openWA("https://wa.me/?text="+encodeURIComponent(buildWaText()),"_blank")};
      return<div>
        {/* Week selector */}
