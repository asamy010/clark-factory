                  ...
                  >
                    ...
                    <td style={{...colCell, color: T.textSec, fontFamily: "monospace", direction: "ltr"}}>
                      <div style={{display:"flex", alignItems:"center", gap: 8, minWidth: 0}}>
                        ...
                        {/* V21.27.196: زر واتساب — موبايل فقط (طلب Ahmed). wa.me +
                            الرقم القانوني (normalizePhone). stopPropagation. */}
                        {isMob && c.phone ? (
                          <a
                            href={"https://wa.me/" + normalizePhone(c.phone).replace(/[^0-9]/g, "")}
